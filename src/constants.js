  ...
  EXPERIENCE: [
    {
      ...
      fromDate: "Aug 2022",
      toDate: "present",
      subTitle: "Atlassian, UIP Developer Experience",
      infos: [
        `Implemented on Dockerize Visual Regression test environment locally, with cache implementation of pulling latest playwright images and spinning up docker environment with local environment.`,
        `Integration of slack bot notification along with customized messing strategy publishing to channels using playwright report on failure of CI build.`,
        `Extended support for multi exports modules for TS API report using @microsoft/api-extractor`,
        `Worked on creating a version continue release of PAL BOT integration, with continuous rollout strategy`,
      ],
    },
    {
      id: 2,
      ...
      infos: [
        ...
        `Worked on complete revamp of coupon pages, adding special closed group coupons type. Giving easier and interactive UI/UX, which in turn resulted 70% gain in conversion and more than 130% boost in creation of new type, reducing page load time from 2 sec to less than 1 sec and overall flow from 2 step to single view.`,
