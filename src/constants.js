  ...
  EXPERIENCE: [
    {
      ...
      infos: [
        "As highly motivated individual sales maker delivering a high standard of work to meet the required internal / external deadlines.",
        ...
        "Developed Strong Customer Relationship.",
        "Conducted Customer Trainings.",
        "Measured customer support success with clear metrics to attain time specific goal..",
        "Consulted with in house and external stakeholders to resolve discrepancies and create effective solutions.",
        "Cultivated customer loyalty and obtained 100% CSAT scores for assigned accounts.",
        ...
        "Responsible for hygienic customer account information by building Asset Dashboard of the account and keeping the Install Base Up to date and becoming the data masters of the account.",
